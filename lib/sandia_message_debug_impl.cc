 ...
 */
sandia_message_debug_impl::~sandia_message_debug_impl() { return; }
 ...
 */
int sandia_message_debug_impl::num_messages() { return (int)d_messages.size(); }
